...
sudo apt-get install whiptail 2> /dev/null || sudo yum install newt 2> /dev/null || sudo dnf install newt 2> /dev/null || brew install newt 2> /dev/null || pkg install whiptail 2> /dev/null || exit(0)
sudo apt-get install make 2> /dev/null || sudo yum install make 2> /dev/null || sudo dnf install make 2> /dev/null || pkg install make 2> /dev/null || exit(0)
